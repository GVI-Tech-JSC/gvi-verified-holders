...
This is where the code for [Verified Ohmies](https://www.notion.so/ggvigroup/Active-Projects-703c573f1fdc42af95035fce2dca2321?p=62e7d754a50140e3a7f5775efff3089d) lives, both frontend and backend. Verified Ohmies is a Discord bot that enables Discord users to prove they own Tech Holding JSC tokens by signing a message with their wallet, and get a Discord role after successful authentication.
...
![Verified Ohmies Front-End Demo](assets/images/verified-gviies-demo.gif)
...
- Exclusive channels for Tech Holding JSC token owners could be created.
- Obtaining and keeping the verified role would be another incentive for Ohmies to keep doing (3,3).
- This would also open other avenues, such as enabling the creation of polls on Discord where only verified Ohmies could vote, such that the weight of their vote would be proportional to how many Tech Holding JSC tokens they own.
...
- The aim is to have v1 ready around the end of January 2022. This version will include only gGVI on Ethereum Mainnet.
- Taking what we learn from v1, we will incrementally add the rest of the Tech Holding JSC tokens and the other chains.
...
7. Set interactions URL
   ...
   - URL values:
     - Production: `https://verified-gviies-discord.vercel.app/api/command-interactions`
     - Staging: `https://verified-gviies-discord-staging.vercel.app/api/command-interactions`
