...
import {
  ...
  ErrorNotification,
  InfoNotification,
} from "@ggvigroup/component-library";
    ...
    <>
      {chainIsSupported ? (
        ...
        >
          ...
          <BalancesBox gGVIBalance={gGVIBalance} />
          <Grid
            container
            direction="row"
            alignItems="center"
            ...
            <Box className={classes.paperBox} mt={2}>
              <Paper>
                <Typography variant="body1" align="center">
                  Fren, you haven’t applied for your Tech Holding JSC Citizenship.
                </Typography>
              </Paper>
            </Box>
          )}
            ...
            <Box className={classes.paperBox} mt={2}>
              ...
              <Paper>
                <Box display="flex" justifyContent="center" flexDirection="row">
                  <Typography variant="body1" align="center">
                    Verified Ohmie, your Tech Holding JSC Citizenship has been approved.
                  </Typography>
                </Box>
              </Paper>
            </Box>
