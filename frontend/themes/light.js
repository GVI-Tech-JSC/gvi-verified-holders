...
const lightTheme = {
  ...
  primaryButtonHoverBG: "#EEB657",
  // these need fixing
  primaryButtonHoverColor: "#333333",
  secondaryButtonHoverBG: "rgba(54, 56, 64, 1)",
  //hacky way to use the disabled button to show the address
  secondaryButtonDisabledBG: "#6F8B97",
      ...
      overrides: {
        ...
        MuiCssBaseline: {
          "@global": {
            "@font-face": fonts,
            body: {
              backgroundImage: 'url(images/background/bg-light.png)',
        ...
        MuiButton: {
          ...
          containedSecondary: {
            ...
            "&:disabled": {
              backgroundColor: lightTheme.secondaryButtonDisabledBG,
              color: "#FFFFFF"
            },
            "@media (hover:none)": {
              color: lightTheme.color,
