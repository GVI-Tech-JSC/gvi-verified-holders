...
> You need to launch `olympus-api/lambda/verified-gviies/` or deploy it
...
- main branch (production): `https://verified.ggvigroup.finance`
- staging branch: `https://verified-staging.ggvigroup.finance`
...
The `ggvigroup.finance` domains need to be assigned to the project in order to be used:

1. Access the `Domains` tab on the team dashboard in Vercel
2. Select `ggvigroup.finance` and click on the `Add` button
3. Select the frontend project in the list
4. Enter in the domain (e.g. `verified.ggvigroup.finance`) and click `Add`
5. Repeat for `verified-staging.ggvigroup.finance`
