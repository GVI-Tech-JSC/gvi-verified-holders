...
export const TOKENS_AUTH = ["GGVI"];

// The minimum equivalent of GVI that the user must own to be authenticated
// i.e. for GGVI the equivalent in GVI is calculated by taking into account the current index
// for GVI and SGVI it's just the actual value
export const MINIMUM_GVI_EQUIV_AUTH = 0.01;
